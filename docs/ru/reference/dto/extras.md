<!-- languages --> <a href="../../../en/reference/dto/extras.md">English</a> · <a href="extras.md">Русский</a> <!-- /languages -->
# Сохранение дополнительных данных <a id="section-1"></a>

Для собственной модели пометьте объявленное свойство `#[Extras]`; внешний эквивалент — `DtoRules::extras()`. Реестр классов не нужен. Wire-сериализатор обнаруживает атрибут также у вручную созданных и вложенных DTO до первого hydrate; обычный toArray() сохраняет receiver.

## Дополнительные поля <a id="section-2"></a>

Рекомендуемое имя технического свойства — `_extra`. Свойство помечается `#[Extras]` либо задаётся внешним
