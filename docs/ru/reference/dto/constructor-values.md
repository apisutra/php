...
эта проверка равенства сравнивает пустые контейнеры как PHP-массивы. Объявленные
[формы](shapes.md#section-3) проверяют исходный вид JSON раньше; равенство
constructor value не добавляет гарантии обратимого JSON round-trip.
