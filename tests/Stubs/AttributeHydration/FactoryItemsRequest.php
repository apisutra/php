...
#[Get('/items')]
#[Pagination(itemsPath: 'response.rows', itemsType: Row::class, itemsCollectionFactory: TestItemCollectionFactory::class)]
final class FactoryItemsRequest extends AbstractPaginatedRequest
{
}
