...
abstract class BaseStubClient implements ClientInterface
{
    ...
    {
        throw new RuntimeException('Отправка не используется в тестах реестра.');
    }
    ...
    {
        throw new RuntimeException('Ответ не используется в тестах реестра.');
    }
    ...
    {
        throw new RuntimeException('Continuation не используется в тестах реестра.');
    }
}
