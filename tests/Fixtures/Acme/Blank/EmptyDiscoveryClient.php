...
/**
 * Клиент без запросов — используется для проверки,
 * что детектор бросает исключение, если запросы не найдены.
 */
final class EmptyDiscoveryClient implements ClientInterface
{
